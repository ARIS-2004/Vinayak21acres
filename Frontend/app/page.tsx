...
function IconSecurity() {
  return (
    ...
    >
      <path
        d="M24 4L8 11v13c0 9 7 17 16 20 9-3 16-11 16-20V11L24 4z"
...
function IconFire() {
  return (
    ...
    >
      ...
      <path
        d="M24 20c0 0-5 5-5 10a5 5 0 0010 0C29 25 24 20 24 20z"
        fill={RED}
        fillOpacity="0.2"
      />
    </svg>
...
function IconPool() {
  return (
    ...
    >
      ...
      <path
        d="M12 22l8-10 6 8 6-4"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M6 34c4 0 4 4 8 4s4-4 8-4 4 4 8 4 4-4 8-4"
        strokeLinecap="round"
      />
      <path
        d="M6 42c4 0 4-4 8-4s4 4 8 4 4-4 8-4 4 4 8 4"
        strokeLinecap="round"
      />
    </svg>
  );
...
const paymentMilestones = [
  ...
  {
    milestone: "On Agreement Execution / Registration",
    amount: "10% + 50% Legal + GST",
  },
  ...
  {
    milestone: "On Lift Installation Commencement",
    amount: "5% + 100% EC&D + 50% Legal + GST",
  },
...
const floorPlanData: Record<
  string,
  { overview: string; units: FloorPlanUnit[] }
> = {
  "Tower 2A": {
    ...
    units: [
      {
        ...
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2A  Type A~ 3BHK 3T (Luxury).png",
        odd: { carpet: "873", balcony: "147", bua: "1107", sbua: "1476" },
        even: { carpet: "873", balcony: "158", bua: "1118", sbua: "1491" },
      },
      {
        type: "Type B",
        config: "2BHK + 2T",
        category: "Standard",
        image: "/gallery/Floorplans/Tower 2A  Type B~ 2BHK 2T.png",
        odd: { carpet: "596", balcony: "60", bua: "728", sbua: "971" },
      },
      {
        type: "Type C",
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2A  Type C~ 3BHK 3T (Luxury).png",
        odd: { carpet: "826", balcony: "134", bua: "1048", sbua: "1398" },
        even: { carpet: "826", balcony: "149", bua: "1064", sbua: "1418" },
      },
      {
        type: "Type D",
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2A  Type D~ 3BHK 3T (Luxury).png",
        odd: { carpet: "829", balcony: "133", bua: "1049", sbua: "1399" },
        even: { carpet: "829", balcony: "152", bua: "1068", sbua: "1424" },
      },
      {
        type: "Type E",
        config: "3BHK + 2T",
        category: "Smart",
        image: "/gallery/Floorplans/Tower 2A  Type E~ 3BHK 2T (Smart).png",
        odd: { carpet: "703", balcony: "82", bua: "854", sbua: "1138" },
        even: { carpet: "703", balcony: "99", bua: "871", sbua: "1162" },
      },
      {
        type: "Type F",
        config: "3BHK + 2T",
        category: "Comfort",
        image: "/gallery/Floorplans/Tower 2A  Type F~ 3BHK 2T (Comfort).png",
        odd: { carpet: "774", balcony: "87", bua: "938", sbua: "1250" },
        even: { carpet: "774", balcony: "101", bua: "951", sbua: "1268" },
      },
      {
        type: "Type G",
        config: "2BHK + 2T",
        category: "Standard",
        image: "/gallery/Floorplans/Tower 2A  Type G~ 2BHK 2T.png",
        odd: { carpet: "595", balcony: "60", bua: "728", sbua: "971" },
      },
      {
        type: "Type H",
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2A  Type H~ 3BHK 3T (Luxury).png",
        odd: { carpet: "879", balcony: "147", bua: "1109", sbua: "1479" },
        even: { carpet: "879", balcony: "157", bua: "1119", sbua: "1492" },
      },
    ],
  },
  "Tower 2B": {
    ...
    units: [
      {
        ...
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2B  Type A ~ 3BHK 3T (Luxury).png",
        odd: { carpet: "877", balcony: "146", bua: "1106", sbua: "1475" },
        even: { carpet: "877", balcony: "157", bua: "1117", sbua: "1490" },
      },
      {
        type: "Type B",
        config: "2BHK + 2T",
        category: "Standard",
        image: "/gallery/Floorplans/Tower 2B  Type B ~ 2BHK 2T.png",
        odd: { carpet: "596", balcony: "60", bua: "728", sbua: "971" },
      },
      {
        type: "Type C",
        config: "3BHK + 2T",
        category: "Comfort",
        image: "/gallery/Floorplans/Tower 2B  Type C ~ 3BHK 2T (Comfort).png",
        odd: { carpet: "783", balcony: "82", bua: "940", sbua: "1253" },
        even: { carpet: "783", balcony: "97", bua: "955", sbua: "1274" },
      },
      {
        type: "Type D",
        config: "3BHK + 2T",
        category: "Smart",
        image: "/gallery/Floorplans/Tower 2B  Type D ~ 3BHK 2T (Smart).png",
        odd: { carpet: "703", balcony: "82", bua: "852", sbua: "1136" },
        even: { carpet: "703", balcony: "99", bua: "870", sbua: "1160" },
      },
      {
        type: "Type E",
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2B  Type E ~ 3BHK 3T (Luxury).png",
        odd: { carpet: "826", balcony: "137", bua: "1047", sbua: "1397" },
        even: { carpet: "826", balcony: "154", bua: "1065", sbua: "1420" },
      },
      {
        type: "Type F",
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2B  Type F ~ 3BHK 3T (Luxury).png",
        odd: { carpet: "823", balcony: "138", bua: "1050", sbua: "1400" },
        even: { carpet: "823", balcony: "159", bua: "1070", sbua: "1426" },
      },
      {
        type: "Type G",
        config: "2BHK + 2T",
        category: "Standard",
        image: "/gallery/Floorplans/Tower 2B  Type G ~ 2BHK 2T.png",
        odd: { carpet: "597", balcony: "60", bua: "728", sbua: "971" },
      },
      {
        type: "Type H",
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2B  Type H ~ 3BHK 3T (Luxury).png",
        odd: { carpet: "874", balcony: "146", bua: "1108", sbua: "1477" },
        even: { carpet: "874", balcony: "157", bua: "1119", sbua: "1492" },
      },
    ],
  },
  "Tower 2C": {
    ...
    units: [
      {
        ...
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2C  Type A ~ 3BHK 3T (Luxury).png",
        odd: { carpet: "942", balcony: "109", bua: "1133", sbua: "1511" },
        even: { carpet: "942", balcony: "123", bua: "1148", sbua: "1531" },
      },
      {
        type: "Type B",
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2C  Type B ~ 3BHK 3T (Luxury).png",
        odd: { carpet: "942", balcony: "108", bua: "1133", sbua: "1511" },
        even: { carpet: "942", balcony: "110", bua: "1135", sbua: "1513" },
      },
      {
        type: "Type C",
        config: "3BHK + 2T",
        category: "Smart",
        image: "/gallery/Floorplans/Tower 2C  Type C ~ 3BHK 2T (Smart).png",
        odd: { carpet: "698", balcony: "82", bua: "847", sbua: "1130" },
        even: { carpet: "698", balcony: "99", bua: "865", sbua: "1153" },
      },
      {
        type: "Type D",
        config: "3BHK + 3T",
        category: "Comfort",
        image: "/gallery/Floorplans/Tower 2C  Type D ~ 3BHK 3T (Comfort).png",
        odd: { carpet: "739", balcony: "105", bua: "916", sbua: "1221" },
        even: { carpet: "739", balcony: "122", bua: "934", sbua: "1245" },
      },
      {
        type: "Type E",
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2C  Type E ~ 3BHK 3T (Luxury).png",
        odd: { carpet: "943", balcony: "106", bua: "1129", sbua: "1505" },
        even: { carpet: "943", balcony: "109", bua: "1132", sbua: "1510" },
      },
      {
        type: "Type F",
        config: "3BHK + 3T",
        category: "Luxury",
        image: "/gallery/Floorplans/Tower 2C  Type F ~ 3BHK 3T (Luxury).png",
        odd: { carpet: "942", balcony: "107", bua: "1131", sbua: "1507" },
        even: { carpet: "942", balcony: "123", bua: "1147", sbua: "1530" },
      },
      {
        type: "Type G",
        config: "3BHK + 2T",
        category: "Comfort",
        image: "/gallery/Floorplans/Tower 2C  Type G ~ 3BHK 2T (Comfort).png",
        odd: { carpet: "736", balcony: "107", bua: "913", sbua: "1217" },
        even: { carpet: "736", balcony: "122", bua: "928", sbua: "1237" },
      },
      {
        type: "Type H",
        config: "3BHK + 2T",
        category: "Smart",
        image: "/gallery/Floorplans/Tower 2C  Type H ~ 3BHK 2T (Smart).png",
        odd: { carpet: "698", balcony: "83", bua: "848", sbua: "1131" },
        even: { carpet: "698", balcony: "98", bua: "863", sbua: "1151" },
      },
    ],
  },
};
...
function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <Image
              src="/evernal.png"
              alt="Evernal Properties — Authorized Channel Partner"
              width={110}
              height={40}
              className="object-contain h-9 w-auto hidden sm:block"
            />
          </div>
          ...
          >
            <span
              className={`block h-0.5 bg-gray-800 rounded-full transition-all duration-300 origin-center ${menuOpen ? "w-6 rotate-45 translate-y-[7px]" : "w-6"}`}
            />
            <span
              className={`block h-0.5 bg-gray-800 rounded-full transition-all duration-300 ${menuOpen ? "opacity-0 w-0" : "w-4"}`}
            />
            <span
              className={`block h-0.5 bg-gray-800 rounded-full transition-all duration-300 origin-center ${menuOpen ? "w-6 -rotate-45 -translate-y-[7px]" : "w-6"}`}
            />
      ...
      <div
        className={`fixed inset-0 z-[60] lg:hidden transition-all duration-300 ${menuOpen ? "pointer-events-auto" : "pointer-events-none"}`}
      >
        {/* Backdrop */}
        <div
        ...
        {/* Drawer panel */}
        <div
          className={`absolute top-0 right-0 h-full w-[78%] max-w-[320px] bg-white flex flex-col shadow-2xl transition-transform duration-300 ease-out ${menuOpen ? "translate-x-0" : "translate-x-full"}`}
        >
          {/* Drawer header */}
              ...
              >
                <div className="flex items-center gap-4">
                  <span
                    ...
                    style={{ color: PINK_BG, WebkitTextStroke: `1px ${RED}` }}
                  >
          ...
          <div className="px-6 py-6 border-t border-gray-100 space-y-3">
            ...
            <p className="text-center text-[10px] text-gray-400 tracking-wide">
              New Town · Kolkata · RERA Approved
            </p>
          </div>
        </div>
      </div>
...
function Hero() {
  return (
    <section
      id="hero"
      className="relative w-full h-[80vh] min-h-[560px] flex items-end"
    >
      <Image
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pb-12 w-full">
        <p className="text-white/80 text-xs sm:text-sm tracking-widest uppercase mb-2">
          Off New Town Action Area III, Kolkata
        </p>
        <h1 className="text-white text-3xl sm:text-5xl md:text-6xl font-bold leading-tight mb-4">
          Vinayak 21 Acres
        </h1>
  ...
  return (
    <div ref={ref} className="relative">
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="flex items-center gap-1.5 text-sm font-medium text-gray-900 focus:outline-none"
      >
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src={`https://flagcdn.com/w40/${value.iso.toLowerCase()}.png`}
          alt=""
          className="w-5 h-auto rounded-sm shadow-sm"
        />
        <svg
          className="w-3 h-3 text-gray-900/60"
          fill="currentColor"
          viewBox="0 0 20 20"
        >
          <path
      ...
      {open && (
        <div className="absolute left-0 top-full mt-2 w-56 max-h-[260px] overflow-y-auto bg-white rounded-lg shadow-2xl ring-1 ring-black/10 z-50">
          {countries.map((c) => (
            <button
              key={c.iso + c.name}
              type="button"
              ...
              className={`w-full flex items-center gap-2 px-2.5 py-1.5 text-left hover:bg-gray-50 ${c.iso === value.iso ? "bg-gray-50" : ""}`}
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                ...
                alt=""
                loading="lazy"
                className="w-4 h-auto rounded-sm shadow-sm flex-shrink-0"
              />
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <p className="text-gray-600 text-base leading-relaxed mb-6">
              Vinayak 21 Acres is a premium residential township in New Town,
              Kolkata, spread across 21 acres of thoughtfully planned
              development. Offering well-designed 2 and 3 BHK high-rise
              apartments, the project blends modern living with spacious
              comfort. With expansive green open spaces, premium amenities, and
              multiple lifestyle clubhouses, Vinayak 21 Acres delivers a
              well-rounded community living experience.
            </p>
            <ul className="space-y-3 mb-8">
              {[
                ...
                >
                  <span style={{ color: RED }} className="mt-0.5 flex-shrink-0">
                    ✓
                  </span>
                  {item}
                </li>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
          {[
            ...
            <div key={label} className="text-center border rounded-lg p-6">
              <div style={{ color: RED }} className="text-2xl font-bold">
                {val}
              </div>
...
function Amenities() {
  return (
    <section id="amenities" style={{ background: PINK_BG }} className="py-10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={card.title} className="bg-white rounded-xl p-6 shadow-sm">
              <h3 style={{ color: RED }} className="font-bold text-lg mb-2">
                {card.title}
              </h3>
...
function Price() {
  return (
    <section id="price" className="py-10 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div>
          <div>
            {/* Unit types table */}
            <h3 style={{ color: RED }} className="font-bold text-xl mb-4">
              Unit Configurations
            </h3>
            ...
            <p className="text-xs text-gray-500 mt-4 leading-relaxed">
              * Price includes unit charges. Extra charges: Electricity
              Connection & Transformer, Generator, Legal, Club / Amenities
              Development, Association Formation, Deposits, and Applicable GST.
    ...
    <section id="location" className="py-10 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-center text-gray-500 mb-14 max-w-2xl mx-auto">
          200 m from 6-lane highway · 400 m from Infosys · Shuttle bus service
          to the nearest metro for residents
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {(
              Object.entries(nearbyPlaces) as [
                string,
              ...
              <div key={category} className="bg-gray-50 rounded-xl p-4">
                <h4
                  style={{ color: RED }}
                  className="font-bold text-sm uppercase tracking-wide mb-3 capitalize"
                >
                  {category === "work"
                    ? "IT Hubs"
                    : category === "colleges"
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-500 text-sm">
            <strong style={{ color: RED }}>Site Address:</strong> Vinayak 21
            Acres, Hatishala, Off Newtown Action Area III, Kolkata
          </p>
          <p className="text-gray-500 text-sm mt-1">
            <strong style={{ color: RED }}>Corporate:</strong> Vinayak Corporate
            House, 122/1R Satyendranath Majumder Sarani, Kolkata 700 026
          </p>
        </div>
      </div>
    </section>
...
function Developer() {
  return (
    <section className="py-10" style={{ background: PINK_BG }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-10">
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              For nearly four decades, Vinayak Group has been changing Kolkata's
              residential landscape. Built on a consistent, customer-first
              approach, their projects reflect focus on thoughtful planning,
              reliable delivery and a standard of quality that has earned
              enduring trust over time.
            </p>
            <div className="grid grid-cols-3 gap-2 sm:gap-6 text-center">
              {[
                ["45+", "Projects Delivered"],
                ["5.7M sq ft", "Under Construction"],
                ["7000+", "Happy Residents"],
              ].map(([val, label]) => (
                <div key={label}>
                  <div
                    style={{ color: RED }}
          ...
          <div className="lg:w-1/2 relative aspect-video rounded-xl overflow-hidden shadow-lg w-full">
            <Image
              src="/gallery/WATERBODY_EXPERIENCE_VIEW.jpg"
              alt="Vinayak Group"
              fill
              className="object-cover"
            />
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(ellipse 80% 50% at 50% 0%, rgba(123,19,19,0.18) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-14 pb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-5">
              Premium residential township in New Town, Kolkata. Experience
              elevated living across 21 curated acres.
            </p>
            <div
              className="rounded-lg border border-white/10 px-4 py-3"
              style={{ background: "rgba(255,255,255,0.03)" }}
            >
              <p className="text-[9px] tracking-[0.2em] uppercase text-white/40 mb-2">
                Marketed by
              </p>
              <Image
                src="/evernal.png"
                ...
                width={160}
                height={48}
                className="object-contain h-10 w-auto max-w-full brightness-0 invert opacity-90"
              />
            </div>
          </div>
          ...
          <div>
            <p
              className="text-white text-[11px] font-semibold tracking-[0.2em] uppercase mb-5"
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {quickLinks.map(({ label, href }) => (
                ...
                >
                  <span
                    className="block w-3 h-px transition-all duration-300 group-hover:w-5"
                    style={{ background: RED }}
                  />
                  {label}
                </a>
        ...
        <div className="border-t border-white/8 pt-7">
          <p className="text-white/30 text-[11px] leading-relaxed text-center max-w-4xl mx-auto mb-4">
            <span className="text-white/40 font-medium">Disclaimer:</span> This
            document does not constitute an offer, contract, agreement, or
            transaction of any nature. All layout plans are for illustrative
            purposes only. Project design, planning, amenities and phasing are
            subject to statutory approvals. Refer to WBRERA website for complete
            project information. T&amp;C Apply.
          </p>
    ...
    <section className="relative w-full max-h-[85vh] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-black/20 flex flex-col items-center justify-center text-white text-center px-6">
        <p className="text-white/60 text-xs tracking-[0.3em] uppercase mb-4">
          Vinayak 21 Acres · New Town, Kolkata
        </p>
        ...
        <p className="text-white/80 text-sm sm:text-lg max-w-xl mb-6 sm:mb-8 leading-relaxed">
          Where the outdoors and indoors come together, almost seamlessly. Life
          reinvents itself in spacious openness.
        </p>
...
function FloorPlans() {
  ...
  return (
    <section id="floorplans" className="py-8 md:py-12 bg-[#F8F5F0]">
      <style>{`
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-center text-gray-500 mb-12 max-w-xl mx-auto text-sm leading-relaxed">
          Explore detailed floor plans for every unit type across all three
          towers. All areas in sq. ft.
        </p>
              ...
              style={
                activeTower === t
                  ? {
                      background: RED,
                      color: "#fff",
                      boxShadow: "0 6px 20px rgba(123,19,19,0.35)",
            ...
            >
              ...
              <div className="px-5 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
                <span className="text-xs text-gray-400">
                  {tower.units.length} unit configurations
                </span>
          ...
          <div className="w-full lg:w-[64%]">
            ...
            >
              {tower.units.map((unit, i) => {
                const cs = categoryStyle[unit.category] ?? {
                ...
                return (
                  ...
                  >
                    {/* Category colour bar */}
                    <div
                      className="h-[3px] transition-all duration-300 group-hover:h-1"
                    ...
                    <div className="p-3.5">
                      <div className="flex items-start justify-between gap-1 mb-2">
                        ...
                        <span
                          className={`text-[9px] font-bold px-2 py-1 rounded-md flex-shrink-0 leading-tight ${cs.badge}`}
                        >
                          {unit.category}
                        </span>
                      </div>
      ...
      {lightbox && (
        ...
        >
          <div
            ...
            style={{
              maxWidth: lightbox.unit ? "880px" : "720px",
              maxHeight: "92vh",
            }}
          ...
          >
            ...
            <div
              className={`relative bg-[#F8F5F0] flex-shrink-0 overflow-hidden ${lightbox.unit ? "lg:w-[55%] aspect-[3/2] lg:aspect-auto" : "w-full aspect-[4/3] sm:aspect-[16/10]"}`}
            >
              <Image
                src={lightbox.src}
                alt="Floor Plan"
              ...
              <div className="lg:w-[45%] flex flex-col overflow-y-auto border-l border-gray-100">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="text-gray-500 text-sm mt-0.5">
                        {lightbox.unit.config}
                      </p>
                    </div>
                    <span
                      className={`text-[10px] font-bold px-2.5 py-1.5 rounded-lg flex-shrink-0 ${categoryStyle[lightbox.unit.category]?.badge ?? "bg-gray-100 text-gray-500"}`}
                    >
                ...
                <div className="p-6 flex-1">
                      ...
                      <table className="w-full min-w-[320px]">
                        <thead>
                          <tr style={{ background: RED }}>
                            {["Floor", "Carpet", "Balcony", "BUA", "SBUA"].map(
                              (h) => (
                                <th
                                  key={h}
                                  className="px-3 py-2.5 text-left text-white font-semibold text-[11px] whitespace-nowrap"
                                >
                                  {h}
                                </th>
                              ),
                        ...
                        <tbody className="text-xs">
                          <tr className="bg-gray-50 border-b border-gray-100">
                            <td className="px-3 py-3 font-semibold text-gray-700">
                              {lightbox.unit.even ? "Odd" : "All"}
                            </td>
                            <td className="px-3 py-3 text-gray-600">
                              {lightbox.unit.odd.carpet}
                            </td>
                            <td className="px-3 py-3 text-gray-600">
                              {lightbox.unit.odd.balcony}
                            </td>
                            <td className="px-3 py-3 text-gray-600">
                              {lightbox.unit.odd.bua}
                            </td>
                            <td
                              className="px-3 py-3 font-bold"
                              style={{ color: RED }}
                            >
                              {lightbox.unit.odd.sbua}
                            </td>
                          </tr>
                          {lightbox.unit.even && (
                            <tr className="bg-white">
                              ...
                              <td className="px-3 py-3 text-gray-600">
                                {lightbox.unit.even.carpet}
                              </td>
                              <td className="px-3 py-3 text-gray-600">
                                {lightbox.unit.even.balcony}
                              </td>
                              <td className="px-3 py-3 text-gray-600">
                                {lightbox.unit.even.bua}
                              </td>
                              <td
                                className="px-3 py-3 font-bold"
                                style={{ color: RED }}
                              >
                                {lightbox.unit.even.sbua}
                              </td>
                            </tr>
                          )}
                        </tbody>
                  ...
                  <p className="text-[10px] text-gray-400 mt-3 leading-relaxed">
                    * All areas in sq.ft. &nbsp;SBUA = Super Built-Up Area
                  </p>
                </div>
              </div>
            ) : null}
      ...
      <div className="bg-white rounded-2xl overflow-hidden max-w-2xl w-full shadow-2xl flex flex-col md:flex-row max-h-[95vh] overflow-y-auto">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent flex flex-col justify-end p-5">
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              {["₹76L Onwards", "2 & 3 BHK", "RERA Approved"].map((tag) => (
                <span
                  key={tag}
                  className="bg-white/20 backdrop-blur-sm text-white text-[10px] px-2 py-0.5 rounded-full font-medium"
                >
                  {tag}
                </span>
              ))}
        ...
        <div className="md:w-7/12 p-6 flex flex-col">
          <div className="flex items-start justify-between mb-4">
            ...
            <button
              onClick={handleClose}
              className="text-gray-300 hover:text-gray-500 text-2xl leading-none ml-2 flex-shrink-0"
            >
              ×
            </button>
          </div>
          ...
          {submitted ? (
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  await fetch(
                    `${process.env.NEXT_PUBLIC_API_URL}/api/site-visit`,
                    {
                      method: "POST",
                      headers: { "Content-Type": "application/json" },
            ...
            >
              ...
              />
              <div className="flex">
                <span className="border border-r-0 border-gray-200 rounded-l-lg px-3 py-2.5 text-sm bg-gray-100 text-gray-500 font-medium">
                  +91
                </span>
                <input
                  required
...
function ApartmentHighlights() {
  ...
  return (
    <section id="apartments" className="py-10 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-center text-gray-500 mb-14 max-w-2xl mx-auto">
          Open and well-ventilated homes where every square foot is usable.
          Double-height sky terraces add volume and bring the outdoors closer.
        </p>
...
function GreenBuilding() {
  ...
  return (
    <section id="green" className="py-10" style={{ background: PINK_BG }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto text-sm leading-relaxed">
          Sustainability at its core — reducing environmental impact while
          enhancing everyday comfort through smart systems and green
          infrastructure.
        </p>
          ...
          <div className="px-8 py-7 flex flex-col md:flex-row items-center gap-6">
            <div className="text-center md:text-left flex-1">
              ...
              <h3 className="text-white font-bold text-xl md:text-2xl leading-snug">
                IGBC Precertified Platinum Rated Green Building
              </h3>
              <p
                className="text-sm mt-2 leading-relaxed"
                style={{ color: "rgba(255,255,255,0.75)" }}
              >
                Indian Green Building Council&apos;s highest pre-construction
                certification — recognising design excellence in sustainability.
              </p>
            </div>
            <div
              className="flex-shrink-0 rounded-xl px-8 py-4 text-center"
...
function Specifications() {
  const specs = [
    ...
    {
      category: "Electrical",
      items: ["Modular switches throughout", "Copper wiring"],
    },
  ];

  return (
    <section id="specifications" className="py-10 bg-white">
      <div className="max-w-7xl mx-auto px-6">
    ...
    <>
      ...
      <div className="lg:mr-[320px] xl:mr-[360px]">
        <main className="pt-16">
          ...
          {/* Mobile-only enquiry form, shown right after Hero */}
